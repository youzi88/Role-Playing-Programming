========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ParamEdit
========================================================================


AppWizard が生成した ParamEdit には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ParamEdit を構成している各ファイルの概要説明が含まれています。
...
ParamEdit.h
    ...
    みます） をインクルードし、また CParamEditApp アプリケーションクラスを宣
    言します。

ParamEdit.cpp
    このファイルは CParamEditApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ParamEdit.ico
    ...
    ルです。このアイコンはリソース ファイル ParamEdit.rc によってインクルード
    されます。
...
ParamEditDlg.h, ParamEditDlg.cpp - ダイアログ
    これらのファイルは CParamEditDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ParamEdit.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ParamEdit.pch 
